...
namespace Activity2
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            updateUI();
            label4.Text = "Attacking pairs: " + getAttackingPairs(startState);
        }
        ...
        private void updateUI()
        {
            ...
            label1.Text = "Chosen move: " + chosenMove;
        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                for (int j = 0; j < n; j++)
                {
                    ...
                    // draw queens
                    if (j == startState.Y[i])
                        e.Graphics.FillEllipse(Brushes.Gold, i * side, j * side, side-1, side-1);
                }
            }
        }
            ...
            for (int i = 0; i < n; i++)
            {
                for (int j = 0; j < n; j++)
                {
                    ...
                    if (j == currentState.Y[i])
                        e.Graphics.FillEllipse(Brushes.Orange, i * side, j * side, side-1, side-1);
                }
            }
        }

        //Call when Randomize is pressed.
